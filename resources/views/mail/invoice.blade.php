                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:left;color:#525252;">
                                                <p>Hi {{$order->billingAddress?->name ?? $order->shippingAddress->name }},</p>
                                                <p>Your order has been confirmed. Here is your order details. Please contact us if you wish to know more.</p>
                                            </div>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <table 0="[object Object]" 1="[object Object]" 2="[object Object]" border="0" style="cellspacing:0;color:#000;font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;">
                                                ...
                                                <tr>
                                                    <td style="padding: 5px 15px 5px 0;">{{ $item->product->name }}</td>
                                                    <td style="padding: 0 15px;">{{ $item->quantity }}</td>
                                                    <td style="padding: 0 0 0 15px;" align="right">{{ AppHelper::money($item->price) }}</td>
                                                </tr>
                                                @endforeach
                                                <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                    <td style="padding: 5px 15px 5px 0; font-weight:bold">{{ __('SUBTOTAL') }}</td>
                                                    <td style="padding: 0 15px;"></td>
                                                    <td style="padding: 0 0 0 15px; font-weight:bold" align="right">{{ AppHelper::moneyWithSymbol($order->subtotal) }}</td>
                                                </tr>
                                                @settings('tax_enabled')
                                                <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                    <td style="padding: 5px 15px 5px 0; font-weight:bold">{{ __('TAX') }} ({{ $order->tax_rate ?? 0 }}%)</td>
                                                    <td style="padding: 0 15px;"></td>
                                                    <td style="padding: 0 0 0 15px; font-weight:bold" align="right">{{ AppHelper::moneyWithSymbol($order->tax) }}</td>
                                                </tr>
                                                @endsettings
                                                <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                    <td style="padding: 5px 15px 5px 0; font-weight:bold">{{ __('SHIPPING') }}</td>
                                                    <td style="padding: 0 15px;"></td>
                                                    <td style="padding: 0 0 0 15px; font-weight:bold" align="right">{{ AppHelper::moneyWithSymbol($order->shipping_fee) }}</td>
                                                </tr>
                                                <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                    <td style="padding: 5px 15px 5px 0; font-weight:bold">{{ __('DISCOUNT') }}</td>
                                                    <td style="padding: 0 15px;"></td>
                                                    <td style="padding: 0 0 0 15px; font-weight:bold" align="right">{{ AppHelper::moneyWithSymbol($order->discount) }}</td>
                                                </tr>
                                                <tr style="border-bottom:2px solid #ecedee;text-align:left;padding:15px 0;">
                                                    <td style="padding: 5px 15px 5px 0; font-weight:bold">TOTAL</td>
                                                    <td style="padding: 0 15px;"></td>
                                                    <td style="padding: 0 0 0 15px; font-weight:bold" align="right">{{ AppHelper::moneyWithSymbol($order->total) }}</td>
                                                </tr>
                                            </table>
                                                ...
                                                <tr>
                                                    <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                                                        <p style="background:#2F67F6;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                            <a href="{{ route('order.track', ['order'=>$order->order_id]) }}" style="color:#fff; text-decoration:none">
