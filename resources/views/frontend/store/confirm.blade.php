                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-sm mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-2 fw-bold">{{ AppHelper::withBtcSymbol($order->btc_total) }} ({{ AppHelper::moneyWithSymbol($order->total) }})</td>
                                    </tr>
                                    <tr>
                    ...
                    <table class="table table-vcenter table-light">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pe-0 fw-bold text-end">{{ AppHelper::withBtcSymbol($order->btc_total) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
